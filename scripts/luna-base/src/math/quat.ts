// copied from https://github.com/toji/gl-matrix/blob/master/src/quat.js
...
namespace quat {
   ...
   * @returns {quat} out
   */
  export function identity<T extends Quat>(out: T): T {
    out[0] = 0;
    out[1] = 0;
    out[2] = 0;
    out[3] = 1;
   ...
   * @returns {quat} out
   **/
  export function setAxisAngle<T extends Quat>(
    out: T,
    axis: ReadonlyVec3,
    rad: number
  ): T {
   ...
   * @returns {quat} out
   */
  export function multiply<T extends Quat>(
    out: T,
    a: ReadonlyQuat,
    b: ReadonlyQuat
  ): T {
   ...
   * @returns {quat} out
   */
  export function rotateX<T extends Quat>(
    out: T,
    a: ReadonlyQuat,
    rad: number
  ): T {
   ...
   * @returns {quat} out
   */
  export function rotateY<T extends Quat>(
    out: T,
    a: ReadonlyQuat,
    rad: number
  ): T {
   ...
   * @returns {quat} out
   */
  export function rotateZ<T extends Quat>(
    out: T,
    a: ReadonlyQuat,
    rad: number
  ): T {
   ...
   * @returns {quat} out
   */
  export function pow<T extends Quat>(out: T, a: ReadonlyQuat, b: number): T {
    ln(out, a);
    scale(out, out, b);
    exp(out, out);
    return out;
   ...
   * @returns {quat} out
   */
  export function slerp<T extends Quat>(
    out: T,
    a: ReadonlyQuat,
    b: ReadonlyQuat,
    t: number
   ...
   * @returns {quat} out
   */
  export function conjugate<T extends Quat>(out: T, a: ReadonlyQuat): T {
    out[0] = -a[0];
    out[1] = -a[1];
    out[2] = -a[2];
    out[3] = a[3];
   ...
   * @function
   */
  export function fromEuler<T extends Quat>(
    out: T,
    x: number,
    y: number,
    z: number,
